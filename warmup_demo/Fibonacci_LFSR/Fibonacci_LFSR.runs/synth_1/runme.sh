...
HD_PWD='E:/ECE532/Fibonacci_LFSR/Fibonacci_LFSR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fibonacci_LFSR.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Fibonacci_LFSR.tcl
