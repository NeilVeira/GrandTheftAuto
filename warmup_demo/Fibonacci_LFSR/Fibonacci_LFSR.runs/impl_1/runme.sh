...
HD_PWD='E:/ECE532/Fibonacci_LFSR/Fibonacci_LFSR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fibonacci_LFSR.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Fibonacci_LFSR.tcl -notrace
