...
HD_PWD='E:/ECE532/IPs/ip_repo/edit_Fib_LFSR_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fib_LFSR_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Fib_LFSR_v1_0.tcl -notrace
