...
HD_PWD='C:/Users/Neil/Documents/Neil/EngSci/year_4_winter/ECE532/image_processing/image_processor/image_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_processor.vds -m64 -mode batch -messageDb vivado.pb -notrace -source image_processor.tcl
