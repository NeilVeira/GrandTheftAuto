...
HD_PWD='C:/Users/Neil/Documents/Neil/EngSci/year_4_winter/ECE532/image_processing/image_processor/image_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_processor.vdi -applog -m64 -messageDb vivado.pb -mode batch -source image_processor.tcl -notrace
