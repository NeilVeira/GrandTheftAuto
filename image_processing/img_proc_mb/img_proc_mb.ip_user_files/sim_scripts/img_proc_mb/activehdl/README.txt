...
#
# Generated by export_simulation on Tue Feb 28 14:46:19 -0500 2017
#
################################################################################
...
switch to the './img_proc_mb.sh' script.

./img_proc_mb.sh -reset_run
...
./img_proc_mb.sh -noclean_files

For more information on the script, please type './img_proc_mb.sh -help'.
