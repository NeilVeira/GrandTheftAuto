...
HD_PWD='C:/Users/Neil/Documents/Neil/EngSci/year_4_winter/ECE532/GrandTheftAuto/img_proc_full_v2/jpeg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log image_processor_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source image_processor_wrapper.tcl -notrace
