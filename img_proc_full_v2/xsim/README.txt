...
#
# Generated by export_simulation on Fri Mar 17 12:07:57 -0400 2017
#
################################################################################
...
switch to the './jpeg_testbench.sh' script.

./jpeg_testbench.sh -reset_run
...
./jpeg_testbench.sh -noclean_files

For more information on the script, please type './jpeg_testbench.sh -help'.
