...
HD_PWD='C:/Users/Neil/Documents/Neil/EngSci/year_4_winter/ECE532/remote_controller/remote_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log remote_controller.vdi -applog -m64 -messageDb vivado.pb -mode batch -source remote_controller.tcl -notrace
