...
HD_PWD='C:/Users/Neil/Documents/Neil/EngSci/year_4_winter/ECE532/remote_controller/remote_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log remote_controller.vds -m64 -mode batch -messageDb vivado.pb -notrace -source remote_controller.tcl
